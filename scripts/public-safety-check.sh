...
LOCAL_TEMPLATE_PATTERN="(^|/)(99_[^/]*_template|[^/]*_harness)(/|$)"
CONTENT_PATTERN="(${PRIVATE_USER_PATH}|${LOCAL_TEMPLATE_PATTERN}|${OPENAI_KEY_PREFIX}|${KEY_LIKE_PATTERN}|${INTERNAL_PRD}|${INTERNAL_ROADMAP})"
