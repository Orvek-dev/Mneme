...
pub(crate) struct TeamActual {
    ...
    pub(crate) open_run_count: usize,
    pub(crate) closed_run_count: usize,
    ...
    pub(crate) sync_checksum_verified: bool,
    ...
    pub(crate) quality_duplicate_group_count: usize,
    pub(crate) quality_conflict_group_count: usize,
