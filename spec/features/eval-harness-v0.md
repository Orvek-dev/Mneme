...
| REQ-EVAL-007 | `docs/eval-harness/eval-scenario-format.md` | verified |
| REQ-EVAL-008 | `mneme-eval validate --suite core` and invalid fixture CI check | verified |
| REQ-EVAL-009 | `--target fake`, `--target mneme-v1`, `EvalTarget`, and `docs/eval-harness/eval-target-adapter-contract.md` | verified |
...
| REQ-EVAL-012 | `docs/eval-harness/eval-harness-acceptance.md` | verified |
