...
Measured for `v0.50.0` on 2026-05-25.
...
| Public scenario suites | `core`, `runtime`, `agent`, `dogfood`, `model` | `36` public scenarios passed through quality gates |
...
candidate promotion, trend comparison, and safety checks.
