...
Measured for `v0.72.0` on 2026-05-30.
...
| Outcome gate | Acceptance template/validation, external verifier report, external judgment verdict intake, first-class `gate_result`, CLI/MCP status, and non-zero failed gate path | MVP1/MVP2 smoke passed locally |
...
| Outcome Gate | template/validation/acceptance/verifier/judgment/gate_result smoke required by quality gate |
