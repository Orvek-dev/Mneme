...
Measured for `v0.74.0` on 2026-05-30.
...
| Outcome gate | Acceptance template/validation, verifier hash/manifest trust, external verifier report, external judgment verdict intake, first-class `gate_result`, CLI/MCP workflow guard, and non-zero failed gate path | MVP1/MVP2 smoke, verifier pinning, and MCP handoff guard passed locally |
...
| Outcome Gate | template/validation/acceptance/verifier-integrity/judgment/gate_result smoke plus MCP task workflow handoff guard required by quality gate |
